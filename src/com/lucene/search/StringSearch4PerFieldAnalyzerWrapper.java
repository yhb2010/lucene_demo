...
import com.lucene.index.StringIndexer4PerFieldAnalyzerWrapper;
 ...
 *
 */
public class StringSearch4PerFieldAnalyzerWrapper {
	private static String keyword = "山水国内";

	public static void main(String[] args) throws Exception {
		IndexerInterface indexer = new StringIndexer4PerFieldAnalyzerWrapper();
