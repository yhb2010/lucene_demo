...
/**
 * MoreLikeThisQuery的使用，相似查询
 * 
 * @author dell
 * 
 */
public class StringSearch4MoreLikeThisQuery {
	private static String kw = "php开发工程师，工程师";
	...
	public static void main(String[] args) throws Exception {
		...
		String[] moreLikeFields = { "info" }; // { "Name" ,"Info"};
		Analyzer analyzer = new ComplexAnalyzer();
		MoreLikeThisQuery query = new MoreLikeThisQuery(kw, moreLikeFields,
				analyzer, null);
		// 最少的词频
		query.setMinTermFrequency(2);

		// 最多的查询词数目
		query.setMaxQueryTerms(50);

		// 词至少在这么多篇文档中出现
		query.setMinDocFreq(2);
