...
import com.lucene.index.StringIndexer4Synonym;
 ...
 * 
 */
public class StringSearch4Synonym {
	private static String keyword = "好看";

	public static void main(String[] args) throws Exception {
		IndexerInterface indexer = new StringIndexer4Synonym();
