...
import com.lucene.index.methd.Indexer4Metaphone;

public class StringIndexer4Metaphone implements IndexerInterface {
	private String[] str = new String[] { "cool cat" };
	...
	public void addDocuments(Directory dir) throws IOException {
		Indexer4Metaphone indexer = new Indexer4Metaphone();
