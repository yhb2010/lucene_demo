...
public class StringIndexer4FilteredQuery implements IndexerInterface {
	private String[] bookNames = new String[] { "钢铁是怎样炼成的", "钢铁战士", "篱笆女人和狗",
			"女人是水做的", "英雄儿女", "白毛女", "我的兄弟和女儿", "张三丰" };
	private String[] isbns = new String[] { "0000001", "0000002", "0000003",
			"0000004", "0000005", "0000006", "0000007", "0000008" };
	private String[] categorys = new String[] { "education", "education",
			"story", "education", "education", "education", "education", "story" };
	...
	public void addDocuments(Directory dir) throws IOException {
		...
		for (int i = 0; i < bookNames.length; i++) {
			...
			doc.add(new StringField("isbn", isbns[i], Field.Store.YES));
			doc.add(new StringField("category", categorys[i], Field.Store.YES));
